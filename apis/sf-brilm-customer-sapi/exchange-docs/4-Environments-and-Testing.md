## Overview
The Salesforce Brilliant Mule Customer System API is deployed across multiple environments supporting development, testing, and production use cases.
...
You can use the API mocking service to simulate the behavior of the Salesforce Brilliant Mule Customer System API and test client integrations without requiring access to a deployed instance. At this time, no predefined scenarios or example data are configured.
