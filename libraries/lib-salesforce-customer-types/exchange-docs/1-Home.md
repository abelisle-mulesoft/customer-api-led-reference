...
API designers are encouraged to use this library for system-aligned data structures and to utilize the Common Response Types Library for response envelopes.
