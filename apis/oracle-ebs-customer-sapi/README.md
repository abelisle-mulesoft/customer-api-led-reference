...
This API provides access to customer data in Oracle EBS using system-specific structures, identifiers, and constraints.

It reflects the capabilities and limitations of the underlying system, including the use of Oracle EBS data models and integration patterns, and does not abstract or normalize data into a canonical model.
...
- Providing access to customer data in Oracle EBS.
...
- Retrieve customer records from Oracle EBS.
- Create and update customer data where supported.
- Expose Oracle EBS-specific identifiers and attributes.
...
API consumers and Process APIs use this API to interact with customer data in Oracle EBS.
